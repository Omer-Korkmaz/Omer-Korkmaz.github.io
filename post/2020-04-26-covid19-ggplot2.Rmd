...
Data wrangling is done mostly using tidyverse^[https://www.tidyverse.org/] package. Tidyverse is a set of R packages for data science. It includes ggplot2 as well as other packages to use in everyday data analyses, such as dplyr, tidyr, tibble and many others.
